"""
    Our variouss U-Net models each able to handle a different input size:
        - 128x128x3
        - 256x256x3
        - 512x512x3
        - 1024x1024x3
    The intial default learning rate are set at 5e-3
"""
...
def get_unet_128(input_shape=(128, 128, 3),
    ...
    model.compile(optimizer=RMSprop(lr=model_lr), loss=bce_dice_loss, metrics=['accuracy', dice_coeff])
